...
#define _nstates2	18	/* Recepteur */
#define minseq2	44
#define maxseq2	60
#define _endstate2	17

#define _nstates1	28	/* Reseau */
#define minseq1	17
#define maxseq1	43
#define _endstate1	27

#define _nstates0	18	/* Emetteur */
#define minseq0	0
#define maxseq0	16
...
#define PRecepteur	((P2 *)_this)
typedef struct P2 { /* Recepteur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PReseau	((P1 *)_this)
typedef struct P1 { /* Reseau */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define PEmetteur	((P0 *)_this)
typedef struct P0 { /* Emetteur */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
